...
func RunGrpoTrainingHubMultiGpuDistributedTraining(t *testing.T, nnodes int) {
	...
	shellCmd := fmt.Sprintf(
		"set -e; "+
			...
			"export AWS_STORAGE_BUCKET_GRPO_DIR=%s; "+
	...
	common.CreateNotebook(test, namespace, userToken, command, cm.Name, grpoNotebookName, 0, rwxPvc, common.ContainerSizeMedium, common.GetRecommendedNotebookImageFromImageStream(test, common.NotebookImageStreamTrainingHubCUDA))
