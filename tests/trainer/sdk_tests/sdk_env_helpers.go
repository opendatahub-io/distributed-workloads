...
// 3. Neither set: installer script falls back to its internal defaults
//
// Index behavior:
// - If KUBEFLOW_SDK_INDEX_URL is set, we export it as KUBEFLOW_PYPI_INDEX_URL
...
func buildKubeflowInstallExports() string {
	...
	indexURL := strings.TrimSpace(os.Getenv("KUBEFLOW_SDK_INDEX_URL"))
