"""
OSFT training script for E2E tests.

Reads the pre-downloaded model from a shared PVC, generates a small synthetic
dataset, runs OSFT training, and validates checkpoints.
...
CKPT_DIR = os.environ.get("OSFT_CKPT_DIR", "/tmp/checkpoints/osft")
N_SAMPLES = int(os.environ.get("OSFT_N_SAMPLES", "100"))
UNFREEZE_RANK_RATIO = float(os.environ.get("OSFT_UNFREEZE_RANK_RATIO", "0.1"))
MAX_SEQ_LEN = int(os.environ.get("OSFT_MAX_SEQ_LEN", "128"))
MAX_TOKENS_PER_GPU = int(os.environ.get("OSFT_MAX_TOKENS_PER_GPU", "128"))
EFFECTIVE_BATCH_SIZE = int(os.environ.get("OSFT_EFFECTIVE_BATCH_SIZE", "4"))
LEARNING_RATE = float(os.environ.get("OSFT_LEARNING_RATE", "1e-5"))
