...
def parse_args():
    ...
    parser.add_argument("--train-path", type=str, default=os.path.join(file_path,"data/train.jsonl"),
                        help="Path to training jsonl file")

    parser.add_argument("--test-path", type=str, default=os.path.join(file_path,"data/test.jsonl"),
                        help="Path to testing jsonl file")

    parser.add_argument("--special-token-path", type=str, default=os.path.join(file_path,"data/tokens.json"),
    ...
    parser.add_argument("--ds-config", type=str, default=os.path.join(file_path,"zero_3_llama_2_7b.json"),
...
def main():
    ...
    if args.lora:
        with open(f"./lora.json", "r") as json_file:
